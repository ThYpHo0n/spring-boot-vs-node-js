...
(
    ...
    author text COLLATE pg_catalog."default" NULL,
    isbn text COLLATE pg_catalog."default" NULL,
    year integer NULL,
...
(
    ...
    first_name text COLLATE pg_catalog."default" NULL,
    last_name text COLLATE pg_catalog."default" NULL,
